...
battery_capacity=$(cat "/sys/class/power_supply/$BATERY/capacity") # get battery capacity in percentage
battery_capacity_status=$(cat "/sys/class/power_supply/$BATERY/status") # get battery status
